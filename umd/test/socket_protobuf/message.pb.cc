...
void InitDefaults() { ::google::protobuf::internal::InitSCC(&scc_info_Person.base); }
...
{
    AddDescriptors();
    AssignDescriptors("message.proto", schemas, file_default_instances, TableStruct::offsets, file_level_metadata, NULL,
                      NULL);
}
...
void AddDescriptorsImpl()
{
    ...
    static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        "\n\rmessage.proto\022\007example\"1\n\006Person\022\014\n\004na"
        "me\030\001 \001(\t\022\n\n\002id\030\002 \001(\005\022\r\n\005email\030\003 \001(\tb\006pro"
        "to3"};
    ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(descriptor, 83);
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile("message.proto", &protobuf_RegisterTypes);
}
...
{
    ::google::protobuf::internal::InitSCC(&protobuf_message_2eproto::scc_info_Person.base);
    SharedCtor();
    // @@protoc_insertion_point(constructor:example.Person)
}
Person::Person(const Person& from) : ::google::protobuf::Message(), _internal_metadata_(NULL)
{
            ...
            case 1: {
                    ...
                    static_cast<::google::protobuf::uint8>(10u /* 10 & 0xFF */))
                {
                    ...
                    DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                        ...
                        ::google::protobuf::internal::WireFormatLite::PARSE, "example.Person.name"));
                }
                else
                {
                    goto handle_unusual;
            ...
            case 3: {
                    ...
                    static_cast<::google::protobuf::uint8>(26u /* 26 & 0xFF */))
                {
                    ...
                    DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                        ...
                        ::google::protobuf::internal::WireFormatLite::PARSE, "example.Person.email"));
                }
                else
                {
                    goto handle_unusual;
...
void Person::SerializeWithCachedSizes(::google::protobuf::io::CodedOutputStream* output) const
{
    ...
    if (this->name().size() > 0)
    {
        ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            this->name().data(), static_cast<int>(this->name().length()),
            ::google::protobuf::internal::WireFormatLite::SERIALIZE, "example.Person.name");
    ...
    if (this->email().size() > 0)
    {
        ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            this->email().data(), static_cast<int>(this->email().length()),
            ::google::protobuf::internal::WireFormatLite::SERIALIZE, "example.Person.email");
...
{
template <>
GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::example::Person* Arena::CreateMaybeMessage<::example::Person>(Arena* arena)
{
